...
function randomArr(array) {
  if(typeof array !== "object") throw new Error("The argument must be an array.");
...
function randomInt(min, max) {
  if(typeof min !== "number" || typeof max !== "number") throw new Error("The arguments must be numbers.");
...
function randomStr(length) {
  if(typeof length !== "number") throw new Error("The argument must be a number.");
  let str = "";
